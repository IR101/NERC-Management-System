...
namespace DSnOOPwindowsapp {
	...
	/// Summary for acc
	/// </summary>
	public ref class acc : public System::Windows::Forms::Form
	{
	public:
		acc(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(acc::typeid));
			...
			this->label2->Location = System::Drawing::Point(326, 100);
			...
			this->label3->Location = System::Drawing::Point(326, 231);
			...
			this->button1->Location = System::Drawing::Point(394, 344);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(139, 38);
			this->button1->TabIndex = 5;
			this->button1->Text = L"Create";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &acc::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Location = System::Drawing::Point(638, 344);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(139, 38);
			this->button2->TabIndex = 6;
			this->button2->Text = L"Exit";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &acc::button2_Click);
			// 
			// label1
			// 
			...
			this->label1->Location = System::Drawing::Point(404, 27);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(262, 34);
			...
			this->label4->Location = System::Drawing::Point(328, 428);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(303, 19);
			this->label4->TabIndex = 8;
			this->label4->Text = L"Developed by Department of Mechatronics";
			// 
			// panel2
			// 
			...
			this->pictureBox1->Click += gcnew System::EventHandler(this, &acc::pictureBox1_Click);
			// 
			// panel3
			// 
			...
			this->panel3->Location = System::Drawing::Point(364, 139);
			...
			this->panel4->Location = System::Drawing::Point(364, 271);
			...
			this->ClientSize = System::Drawing::Size(850, 454);
